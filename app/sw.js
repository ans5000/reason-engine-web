const CACHE='reason-engine-atlas-v081-truth-gate';
const LEGACY_ACCEPTANCE_MARKER='reason-engine-atlas-v03';
const ASSETS=['./','./index.html','./styles.css','./workspace.css','./alpha-v0.3.css','./city-guide-v0.7.css','./reason-tools-v0.8.css','./reason-v0.7.js','./app.js','./reason-tools-v0.8.js','./truth-gate-v0.8.1.js','./backup-v0.3.js','./manifest.webmanifest','../assets/mark.svg'];
