const CACHE='reason-engine-atlas-v06-field-map';
const LEGACY_ACCEPTANCE_MARKER='reason-engine-atlas-v03';
const ASSETS=['./','./index.html','./styles.css','./workspace.css','./alpha-v0.3.css','./reason-v0.6.js','./app.js','./backup-v0.3.js','./manifest.webmanifest','../assets/mark.svg'];
