const CACHE='reason-engine-atlas-v041';
const ASSETS=['./','./index.html','./styles.css','./workspace.css','./alpha-v0.3.css','./reason-v0.4.js','./app.js','./backup-v0.3.js','./manifest.webmanifest','../assets/mark.svg'];
